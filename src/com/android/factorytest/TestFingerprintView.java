...
class TestFingerprintView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	static final int IMG_WIDTH=800;
	...
	public TestFingerprintView(Context context) {
		super(context);
	...
	public TestFingerprintView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		if(DEBUG) Log.d(TAG,"CameraPreview constructed");
		setFocusable(true);
